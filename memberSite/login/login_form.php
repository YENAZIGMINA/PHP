                    ...
                    <div id="login2">
                            <div id="id_input_button" class="clearfix">
                                <div id="id_pw_title">
                                    <ul>
                                        <li>
                                            <img src="../img/id_title.gif" alt="ID title">
                                        </li>
                                        <li>
                                            <img src="../img/pw_title.gif" alt="Password title">
                                        </li>
                                    </ul>
                                </div><!-- id_pw_title -->
                                <div id="id_pw_input">
                                ...
                                <div id="login_button">
                                    <input type="image" src="../img/login_button.gif" alt="login button">
                                </div><!-- login_button -->
                            </div>

                            <div id="login_line"></div>
                            <div id="join_button">
                                <img src="../img/no_join.gif" alt="no Join">
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="../member/member_form.php">
                                    <img src="../img/join_button.gif" alt="join button">
                                </a>
                            </div>
                        </div>
                    </div>
